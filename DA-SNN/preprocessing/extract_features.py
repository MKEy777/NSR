# 文件名: 2_extract_features_final_with_lds.py
import os
import time
import numpy as np
...
# --- 路径配置 ---
INPUT_DIR         = r"PerSession_4sZScore_62x800"
# **更新输出目录以反映LDS平滑**
OUTPUT_DIR        = f"5Feature_{SELECTED_FEATURE}_LDS_Smoothed_4x{GRID_ROWS}x{GRID_COLS}_AllData"
